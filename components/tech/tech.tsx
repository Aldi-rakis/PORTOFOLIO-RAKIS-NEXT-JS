...
export default function Tech({ id, name, type, imageUrl, url }: SkillProps) {
  ...
  return (
    <motion.div
      ...
      className="mx-auto my-auto mb-8 w-full h-full max-w-xs md:max-w-sm lg:max-w-md"
    >
      <div className="flex  flex-col items-center text-center rounded-lg border-[1.5px] border-red-500 p-4 shadow-lg">
        <div className="mb-2">
