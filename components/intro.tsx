  ...
  return (
    <section ref={ref} id="home" className="mb-8 md:mb-0 max-w-[50rem] mx-auto text-center md:scroll-mt-[100rem]">
      <div className="flex items-center justify-center mb-4 md:mb-8 ">
        ...
        >
          <Image
            ...
            priority={true}
            quality={90}
            className="   image-animation h-50 w-50"
          />
        </motion.div>
      </div>
      ...
      <motion.h1 className="mb-4 mt-2 md:mb-10 md:mt-4 px-4 text-base md:text-4xl font-medium !leading-[1.5]">
        {language === 'EN' ? (
          <>
            <TypeAnimation sequence={["I'am Aldhi Raqiswandri ", 2000, "I'am a Fullstack Developer", 2000,"I'am a Software Enginner",2000, "I'am a Web Developer", 2000]} repeat={Infinity} />
            <p>
      ...
      >
        ...
        <a
          ...
          href="/"
          download
          aria-label="download cv Aldhi Raqiswandri"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            href="https://wa.me/6282287876696?text=Hello Aldi Rakis"
            target="_blank"
            aria-label="Whatsapp Aldhi Raqiswandri"
          >
            <FaWhatsapp />
          </a>
          <a
            ...
            href="https://instagram.com/Aldirakis05"
            target="_blank"
            aria-label="Instagram Aldhi Raqiswandri"
          >
            <FaInstagram />
          </a>
        </div>
